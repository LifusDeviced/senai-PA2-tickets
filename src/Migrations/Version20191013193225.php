 ...
 */
final class Version20191013193225 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cliente (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nome_cliente VARCHAR(150) NOT NULL, cpf VARCHAR(30) NOT NULL, telefone VARCHAR(30) NOT NULL)');
